    ...
    export function button (albab: Buttons, number_of_times: number) {
        if (albab = 1) {
            for (let index = 0; index < number_of_times; index++) {
                ...
                while(!(input.buttonIsPressed(Button.A) || start + 200 <= control.millis())) {}
            ...
            for (let index = 0; index < number_of_times; index++) {
                ...
                let start = control.millis()
                while(!(input.buttonIsPressed(Button.B) || start + 200 <= control.millis())) {}
            ...
            for (let index = 0; index < number_of_times; index++) {
                ...
                let start = control.millis()
                while(!(input.buttonIsPressed(Button.AB) || start + 200 <= control.millis())) {}
            ...
            for (let index = 0; index < number_of_times; index++) {
                ...
                let start = control.millis()
                while(!(input.logoIsPressed() || start + 200 <= control.millis())) {}
